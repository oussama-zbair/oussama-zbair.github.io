...
Scrum uses fixed-length sprints, defined roles, and a sprint backlog. Kanban is a continuous flow system with WIP limits and no prescribed roles or ceremonies. Kanban is better for operational work; Scrum for product development.

**Q: Who can change the Sprint Backlog during a Sprint?**
Only the Development Team can modify the Sprint Backlog during a Sprint. The Product Owner can negotiate scope with the team, but cannot unilaterally add or remove items.
